		...
		<section class="working-panel">
			<div class="container-fluid">
				...
				<div class="all-order mt-5">
					...
					<?php
					$sql = "SELECT * FROM `customer` WHERE CustomerID = '$oid'";
						...
						while ($row=mysqli_fetch_array($query)) {
							...
							echo 
								'<div class="row" style="padding-left: 0px; margin-left:0px;">
									<div class="col-md-2" style="padding-left:40px;padding-right:0;">'.$id.'</div>
									<div class="col-md-2"style="padding-left:0px;">'.$f_name.'  '.$l_name.'</div>
									<div class="col-md-2" style="padding-left: 0px;">'.$Email.'</div>
									<div class="col-md-2" style="padding-left:30px;">'.$Phone.'</div>
									<div class="col-md-2" style="padding-left: 60px;">'.$Address1.','.$Address2.'</div>
									<div class="col-md-2" style="padding-left: 80px;">'.$Postal.'</div>
								</div> <hr>';
