  ...
  <div class="wrapper">
    <section class="sidebar">
      <ul class="nav-bar">
        ...
        <li><a href="cash_inflow_print.php?id1=<?php echo($from)?> && id2=<?php echo($to)?>"><i class="fas fa-print"></i> Print Report</a></li>
      </ul>
    </section>
    ...
    <section class="working-panel">
      <div class="container-fluid">
        ...
        <div class="all-order mt-5">
          ...
          <?php
            $sql = "SELECT salesorder.Date, salesorder.Quantity, salesorder.price, salesorder.price, product.Name FROM salesorder, product WHERE salesorder.ProductID = product.ProductID AND salesorder.Date BETWEEN '$from' AND '$to' ORDER BY salesorder.Date DESC";
