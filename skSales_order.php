			...
			<div class="container-fluid">
				...
				<div class="all-order mt-5">
					...
					<div class="search-area" style="float: left; margin-left: 00px;margin-top: 0px;">
						<form action="skSales_order_sort.php" method="POST">
							<input type="text" name="search_box" class="search-box" placeholder="Order Id...">
					...
					<?php
					$sql = "SELECT salesorder.OrderID, salesorder.Date, salesorder.Quantity, salesorder.CustomerID, salesorder.ProductID, product.Name FROM salesorder, product WHERE salesorder.ProductID = product.ProductID";
