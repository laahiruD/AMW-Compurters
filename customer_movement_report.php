	...
	<div class="wrapper">
		<section class="sidebar">
			<ul class="nav-bar">
				...
				<li><a ><i class="fas fa-print"></i> Print Report</a></li>
			</ul>
		</section>
		...
		<section class="working-panel">
			<div class="container-fluid">
				...
				<div class="all-order">
					...
					<?php
					$sql = "SELECT DISTINCT salesorder.CustomerID, customer.first_name, customer.last_name, COUNT(OID) FROM salesorder, customer WHERE salesorder.CustomerID = customer.CustomerID GROUP BY salesorder.CustomerID ORDER BY COUNT(OID) DESC";
