...
<header>
  ...
  <div class="wrapper">
    <section class="sidebar">
      <ul class="nav-bar">
        <li><a href="cash_inflow_form.php"><i class="fas fa-file-invoice-dollar"></i> Cash Inflow</a></li>
        <li><a href="accountant_home.php"><i class="fas fa-arrow-circle-left"></i> Back</a></li>
        <li><a href="cash_outflow_print.php?id1=<?php echo($from)?> && id2=<?php echo($to)?>"><i class="fas fa-print"></i> Print Report</a></li>
      </ul>
    </section>

    <section class="working-panel">
      <div class="container-fluid">
        <h2 class="text-center">Cash Outflow</h2>
        <hr>

        <div>
          <row>
            <form action="cash_outflow.php" method="POST" style="padding-left: 70px;">
              <br>
              <label>From</label><br>
        ...
        <!-- Table -->
        <div class="all-order mt-4" style="width: 90%; margin-left: 50px;">
          <h4 style="padding-top: 45px;"></h4><hr>
          ...
          <?php
            $sql = "SELECT * FROM `recived_orders` WHERE Date BETWEEN '$from' AND '$to' ORDER BY Date DESC";
