...
<body>
	...
	<div class="wrapper">
		<section class="sidebar">
			<ul class="nav-bar">
				<li><a href="customer_movement_report.php"><i class="fas fa-chart-line"></i> Customer Movement Report</a></li>
				<li><a href="product_demand_report.php"><i class="fas fa-chart-line"></i> Product Demand Report</a></li>
