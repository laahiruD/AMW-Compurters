...
$from = $_GET['id1'];
$to = $_GET['id2'];
$query = "SELECT WEEK(Date) AS week, SUM(DISTINCT(Total)) AS Total FROM salesorder WHERE date(Date) BETWEEN '$from' AND '$to' GROUP BY week ORDER BY Date";
...
<html>
 ...
 <body>
  ...
  <div class = "container" style="padding-left: -0;">
    ...
    <div style="text-align: center; font-size: 24px;"><b><u>Cash Inflow Reoprt</u></b></div>
  ...
  <div class="text-center" style="padding-bottom: 20px;">
    <a href="cash_inflow_form.php" style="padding-right: 15px;"><button class="btn btn-primary" id="print-btn">Back</button></a>
