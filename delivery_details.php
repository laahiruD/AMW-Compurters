			...
			<div class="container-fluid">
				...
				<div class="all-order mt-5">
					...
					<div class="row" style="margin-left: 5px; background: #4353e0 ; padding-left: 40px;">
						...
						<div class="col-md-1 " style="padding-left: 0px;margin-right: 65px;"><b>Receiver</b></div>
					...
					<?php
					$sql = "SELECT `DeliveryID`, `Date`, `OrderID`, `CustomerID`, `Reciver`, `ReciversTp`, `ReciversAdd` FROM `delivery`";
						...
						while ($row=mysqli_fetch_array($query)) {
							...
							echo 
								'<div class="row" >
								 ...
								 <div class="col-md-2" style="margin-right:0px;">'.$oid.'</div>
								 <div class="col-md-2" style="padding-left:0px; padding-right:0;">'.$cid.'</div>
								 <div class="col-md-2" style="padding-left:0px;">'.$reciver.'</div>
								 <div class="col-md-2" style="padding-left:0px;">'.$tp.'</div>
								 <div class="col-md-2" style="padding-left:0px;">'.$add.'</div>
								</div> <hr>';
						}
					}
					?>
