...
<html>
 ...
 <body>
  ...
  <div class = "container" style="padding-left: -0;">
    ...
    <div style="text-align: center; font-size: 24px;"><b><u>Monthly Sales Report (Income)</u></b></div>
  ...
  <div class="text-center" style="padding-bottom: 20px;">
    <a href="income_chart_form.html" style="padding-right: 15px;"><button class="btn btn-primary" id="print-btn">Back</button></a>
