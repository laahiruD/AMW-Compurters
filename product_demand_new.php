    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['category', 'count'],
          <?php
            $sql = "SELECT COUNT(salesorder.ProductID) AS count,product.category AS category FROM salesorder,product WHERE Date BETWEEN '$from' AND '$to' AND salesorder.ProductID = product.ProductID GROUP BY product.category";
    ...
    <div class="wrapper">
      <section class="sidebar">
        <ul class="nav-bar">
         ...
         <a href="product_demand_print.php?id1=<?php echo($from) ?>&id2=<?php echo($to) ?>"><button style="margin-left: 55px;"> <i class="fas fa-print"></i>Print Report</button></a>
      </section>
