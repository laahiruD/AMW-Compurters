...
while($row = mysqli_fetch_array($result))
{
  $arr[]= $row["count"];
  $arr2[]= $row["Total"];
 $chart_data .= "{ Week:".$row["week"]."-".$row2["week"]."+".$one.", Orders:".$row["count"]."}, ";
}
...
<html>
 ...
 <body>
  ...
  <div class = "container" style="padding-left: -0;">
    ...
    <div style="text-align: center; font-size: 24px;"><b><u>Monthly Sales Report (No. of Orders)</u></b></div>
    ...
    <div style="padding-top: 5px; padding-left: 15px;"> Total No. of Orders: <?php echo array_sum($arr); ?></div>
    <div style="padding-top: 5px; padding-left: 15px;"> Monthly Income: Rs. <?php echo array_sum($arr2); ?>.00</div>
    <br>
    <br>
  ...
  <div class="text-center">
    <a href="sales_report_form.html" style="padding-right: 15px;"><button class="btn btn-primary" id="print-btn">Back</button></a>
