		...
		<section class="working-panel">
			<div class="container-fluid">
				...
				<div class="all-order mt-5">
					...
					<?php
					$sql = "SELECT salesorder.Date, salesorder.Quantity, product.price, product.Name FROM salesorder, product WHERE salesorder.ProductID = product.ProductID ORDER BY Date";
						...
						while ($row=mysqli_fetch_array($query)) {
							...
							echo 
								'<div class="row" >
									...
									<div class="col-md-3" style="margin-right:90px;">'.$pname.'</div>
									<div class="col-md-2" style="padding:0px">Rs.'.$uprice.'.00</div>
									<div class="col-md-2" style="padding-left:40px;">'.$qty.'</div>
									<div class="col-md-2" style="padding-left:40px;">Rs.'.$cost.'.00</div>
								</div> <hr>';
						}
					}
					?>
